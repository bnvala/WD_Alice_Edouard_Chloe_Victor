...
<?php include '../wrapper_biens.php'; ?>  
    ...
    <div class="container">
        ...
        <div class="image">
            ...
            <img src='<?php echo $photo; ?>' alt='Photo du bien'>
        </div>
        <div class="info">
            ...
            <!-- Carte Google Maps -->
            <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2530.2660044358527!2d3.014740376473815!3d50.640750771629115!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x47c32aa785fa98bd%3A0x83317c7db567a5b3!2s10%20Av.%20de%20la%20R%C3%A9publique%2C%2059160%20Lille!5e0!3m2!1sfr!2sfr!4v1716993651194!5m2!1sfr!2sfr" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
        </div>
        <?php 
        } else {
            echo "<p>Aucun bien trouvé avec cet ID.</p>";
        }
        ?>
    </div>
            ...
            if ($result->num_rows > 0) {
                ...
                if ($result_agents->num_rows > 0) {
                    while($row_agents = $result_agents->fetch_assoc()) {
                        ...
                        echo '<div class="specialty">' . $row_agents["nom"] . ' ' . $row_agents["prenom"] . '</div>';
                        echo '</div>';
                    }
                } else {
                    echo "<p>Aucun agent trouvé pour ce type de bien.</p>";
                }
            }
            // Fermer la connexion
            $conn->close();
